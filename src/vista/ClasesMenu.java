...
public class ClasesMenu extends JPanel {
	...
	private String[] columnNames = { "Nombre", "Sede", "Estado", "Lugar", "Hora de Inicio", "Hora de Finalizacion",
			"Profesor", "Accion" };
	...
	private void initializeTable() {
		...
		for (Clase clase : clasesAdministradas) {
			...
			Object[] rowData = { nombre, sede, estado, lugar, horaInicio, horaFinalizacion, profesor, "Administrar" };
